...
public class StatsActiveListResource extends ServerResource {
	protected static Logger log = LoggerFactory.getLogger(StatsActiveListResource.class);
	...
	public Collection<UUID> handleStatistics() {
		...
		for (ISOSConnection conn : sosService.getStatistics().getActiveConnections()) {
